module.exports.changeEmailTemplate = (verificationLink, userName = 'User') => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
      <div class="container">
        ...
        <p>You've requested to change your email address. To confirm this change, please click the button below:</p>
        
        <div class="button-container">
          <a href="${verificationLink}" class="button" target="_blank">Verify New Email</a>
        </div>
